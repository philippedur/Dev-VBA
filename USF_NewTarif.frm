VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} USF_NewTarif 
   Caption         =   "USF_NewTarif"
   ClientHeight    =   4410
   ClientLeft      =   120
   ClientTop       =   465
   ClientWidth     =   12285
   OleObjectBlob   =   "USF_NewTarif.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "USF_NewTarif"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit    ' USERFORM UsF_NewTarif !!!!!!!!!!!!!!!!!!
...
Dim TB()
''Dim txt2() As New classe_textb_Usf_NewTarif
''Dim Cmb2() As New classe_combo_Usf_NewTarif
...
Public Sub Userform_initialize()    '///// PAS DE CHECK DE CELLULES VIDES
    ...
    '        Me("ComboBox2").BackColor = Couleur
        Me("ComboBox2").Value = ""    ' c4.Cells(ligne, 14)
...
'''''           Call tri_col_generic(Sheets("TYP_dom"), 1)
        For L = 2 To c4.Range("B" & Rows.Count).End(xlUp).Row
            Me("ComboBox2").AddItem c4.Range("A" & Trim(Str(L))) & "  " & c4.Range("B" & Trim(Str(L))) & "  " & c4.Range("C" & Trim(Str(L))) & "  " & c4.Range("D" & Trim(Str(L)))
        Next
    End With
    ...
    '        For L = 2 To c4.Range("F" & Rows.Count).End(xlUp).Row
    '            Me("Textbox1").AddItem c4.Range("F" & Trim(Str(L)))
    '        Next
    End With
    ...
    '        Me("Textbox3").ForeColor = Couleur
        Me("Textbox3").Value = ""    ' c4.Cells(ligne, 14)
    ...
    With R_t5
    ' Couleur = c4.Cells(ligne, i).Interior.Color
    ...
    '        Me("ComboBox6").BackColor = Couleur
        Me("ComboBox6").Value = ""    ' c4.Cells(ligne, 3).Value
        Me("ComboBox6").FontSize = 10
        Me("ComboBox6").Top = Y
        Me("ComboBox6").Left = X + 105
        Me("ComboBox6").Width = 400
        Me("ComboBox6").Visible = True
        Me("ComboBox6").SpecialEffect = 0
        nbrowmax = c4.Range("A65000").End(xlUp).Row
''        Call tri_col_generic(Sheets("TYP_trav"), 1)
        For L = 2 To nbrowmax
            Me("ComboBox6").AddItem c4.Range("A" & Trim(Str(L))) & " - " & c4.Range("B" & Trim(Str(L))) & " - " & c4.Range("C" & Trim(Str(L))) & " - " & c4.Range("D" & Trim(Str(L))) & CStr(" €")
        Next
    End With
    ...
    ' Couleur = c4.Cells(ligne, i).Interior.Color
    '        Me("ComboBox6").BackColor = Couleur
        Me("TextBox11").Value = ""    ' c4.Cells(ligne, 3).Value
    ...
    ' Couleur = c4.Cells(ligne, i).Interior.Color
    '        Me("ComboBox6").BackColor = Couleur
        Me("ComboBox10").Value = ""    ' c4.Cells(ligne, 3).Value
...
''        Call tri_col_generic(Sheets("TYP_trav"), 1)
        For L = 2 To nbrowmax
            Me("ComboBox10").AddItem c4.Range("A" & Trim(Str(L))) & " - " & c4.Range("F" & Trim(Str(L))) & CStr(" € ")   '  & c4.Range("D" & Trim(Str(L))) & CStr(" €")
        Next
    End With
    ...
    '        Me("Textbox8").BackColor = Couleur
        Me("Textbox8").Value = ""    ' c4.Cells(ligne, 4).Value
    ...
    ' Couleur = c4.Cells(ligne, i).Interior.Color
    '        Me("ComboBox6").BackColor = Couleur
        Me("TextBox12").Value = "MOIS DE FACTURATION (par defaut):"    ' c4.Cells(ligne, 3).Value
    ...
    ' Couleur = c4.Cells(ligne, i).Interior.Color
    '        Me("ComboBox6").BackColor = Couleur
        Me("ComboBox13").Value = ""    ' c4.Cells(ligne, 3).Value
        ...
        Set c4 = Sheets("TYP_dom")
        nbrowmax = c4.Range("I65000").End(xlUp).Row
'        Call tri_col_generic(Sheets("TYP_trav"), 1)
        For L = 2 To nbrowmax
            Me("ComboBox13").AddItem c4.Range("I" & Trim(Str(L)))
        Next
    End With
    k = Month(Date)
...
Public Sub affich_raz()
    Me("Textbox1").Value = ""    ' c4.Cells(ligne, 14)
    Me("ComboBox2").Value = ""    ' c4.Cells(ligne, 14)
    Me("TextBox3").Value = ""      ' c4.Cells(ligne, 2).Value
    Me("ComboBox6").Value = ""    ' c4.Cells(ligne, 3).Value
    Me("Textbox8").Value = ""    'c4.Cells(ligne, 4).Value
    Me("Textbox10").Value = ""    'c4.Cells(ligne, 6).Value
    Me("Textbox12").Value = ""    'c4.Cells(ligne, 6).Value
    Me("Textbox14").Value = ""    'c4.Cells(ligne, 22).Value
    Me("Textbox16").Value = ""    ' c4.Cells(ligne, 8).Value
    Me("Textbox20").Value = ""    'c4.Cells(ligne, 9).Value
    Me("Textbox22").Value = ""    ' c4.Cells(ligne, 11).Value
    Me("Textbox24").Value = ""    'c4.Cells(ligne, 12).Value
    Me("Textbox26").Value = ""    'c4.Cells(ligne, 13).Value
    Me("Textbox28").Value = ""    'c4.Cells(ligne, 14).Value
End Sub
Public Sub affiche1()
    ligne = pos2
    Me("Textbox1").Value = c4.Cells(ligne, 6).Value       ' Societe
    Me("ComboBox2").Value = c4.Cells(ligne, 14).Value       ' Societe
    Me("TextBox3").Value = c4.Cells(ligne, 14).Value       ' Repet Societe
    '    Me("ComboBox6").Value = USF_NewTarif("combobox6").Value        ' Adresse Facturation
    '    Me("Textbox8").Value = c4.Cells(ligne, 20).Value        ' Ville
End Sub
Public Sub affiche2()
    ligne = pos
    Me("Textbox1").Value = c4.Cells(ligne, 6).Value       ' Societe
...
Public Sub Valid_Click()
    If Me("TextBox8").Value <> "" Then
        ...
        ligne = nbrowmax + 1
        If selct = True Then
            c2.Cells(ligne, 1).Value = c4.Cells(pos, 7).Value                       ' Num client
            c2.Cells(ligne, 2).Value = c4.Cells(pos, 14).Value                      ' Societe
            ...
            c2.Cells(ligne, 8) = Date ' UCase(Format(Date, "DD/MM/YYYY"))
        Else
            c2.Cells(ligne, 1).Value = c4.Cells(pos, 7).Value                       ' Num client
            c2.Cells(ligne, 2).Value = c4.Cells(pos, 14).Value                      ' Societe
        ...
        USF_NewTarif.Repaint
        USF_NewTarif.Valid.Enabled = True
    Else
        USF_NewTarif("Textbox8").SetFocus
