VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} USF_Inst_fact 
   Caption         =   "USF_Inst_fact"
   ClientHeight    =   5475
   ClientLeft      =   120
   ClientTop       =   465
   ClientWidth     =   13875
   OleObjectBlob   =   "USF_Inst_fact.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "USF_Inst_fact"
...
Private Declare PtrSafe Function FindWindowA Lib "User32" _
    ...
    Dim TB()
    Dim txt() As New classe_textb_Usf_Inst_fact
    Dim Cmb() As New classe_combo_Usf_Inst_fact
    Public Couleur As Double
    Private Sub set_headers()
    USF_Inst_fact.ListBox2.RowSource = "A2:G20"
End Sub

Private Sub Quitter_Click()
    Unload USF_Inst_fact
End Sub
...
Public Sub Userform_initialize()    '///// PAS DE CHECK DE CELLULES VIDES
    ...
    USF_Inst_fact.BackColor = GetLongFromRGB(192, 224, 192)
    USF_Inst_fact.Print_to_DefaultPrinter.Enabled = True
    USF_Inst_fact.Print_to_DefaultPrinter.BackColor = GetLongFromRGB(192, 224, 192)
    USF_Inst_fact.Valid.Enabled = False
    ...
    With R_L6
        ...
        ColVisu = Array(1, 2, 3, 4, 5, 6, 7, 8)                     ' Adapter
        LargeurCol = Array(50, 150, 150, 30, 30, 50, 50, 70)         ' Adapter
...
''''            Me.ScrollBar1.max = nbrowmax
        Set plage = c2.Range("A2:H" & nbrowmax)
        ' Adapter
...
Public Sub affiche1()
    ...
    USF_Inst_fact.Valid.Enabled = True
...
Public Sub affiche3()
    ...
    With R_L6
        ...
        End If
    End With
    USF_Inst_fact.ListBox2.Top = 55
End Sub
Public Sub Valid_Click()
    If USF_Inst_fact.Valid.Enabled = True Then
        Set c2 = Sheets("Travaux")
